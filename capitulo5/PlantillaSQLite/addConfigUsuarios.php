...
<head>
    ...
    <title>Agregar - ConfigUsuario</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Agregar ConfigUsuario
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">ConfigUsuarios</a>
                            </li>
                            <li class="active">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form role="form" id="frmUser" method="post" action="crudConfigUsuaurio.php?action=crear">
                            ...
                            <div class="form-group">
                                <label>usuario</label>
                                <input id="usuario" name="usuario" class="form-control" placeholder="Yensi Juliet">
                                <p class="help-block">Config usuario.</p>
                            </div>

                            <div class="form-group">
                                <label>piel</label>
                                <input id="piel" name="piel" class="form-control" placeholder="blanca">
                                <p class="help-block">piel del usuario.</p>
                            </div>

         
                             <div class="form-group">
                                <label>respuestas</label>
                                <input id="respuestas" name="respuestas" class="form-control" placeholder="responuesta">
                                <p class="help-block"> respuestas usuario.</p>
                            </div>
